...
{
    public class MenuRenderizdo : ToolStripProfessionalRenderer
    {
        private Color primaryColor;
        private Color textColor;
        private int arrowThickness;

        public MenuRenderizdo(bool isMainMenu, Color primaryColor, Color textColor)

            : base(new ModificarColor(isMainMenu, primaryColor))
        {
